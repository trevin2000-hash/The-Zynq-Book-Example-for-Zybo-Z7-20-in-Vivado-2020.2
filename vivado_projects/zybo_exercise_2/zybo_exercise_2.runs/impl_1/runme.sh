...
HD_PWD='/home/trevin/Documents/Soc_Projects/zybo_excrises/zybo_exercise_2/zybo_exercise_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interput_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interput_wrapper.tcl -notrace
