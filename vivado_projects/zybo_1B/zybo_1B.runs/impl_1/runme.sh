...
HD_PWD='/home/trevin/Documents/Soc_Projects/zybo_excrises/zybo_1B/zybo_1B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_1B_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_1B_wrapper.tcl -notrace
