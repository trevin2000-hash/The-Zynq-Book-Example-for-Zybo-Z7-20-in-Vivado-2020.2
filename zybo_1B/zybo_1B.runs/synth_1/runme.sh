...
HD_PWD='/home/trevin/Documents/Soc_Projects/zybo_excrises/zybo_1B/zybo_1B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_1B_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_1B_wrapper.tcl
