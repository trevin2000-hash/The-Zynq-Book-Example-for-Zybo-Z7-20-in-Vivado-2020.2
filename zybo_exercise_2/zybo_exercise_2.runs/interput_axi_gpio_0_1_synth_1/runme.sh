...
HD_PWD='/home/trevin/Documents/Soc_Projects/zybo_excrises/zybo_exercise_2/zybo_exercise_2.runs/interput_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interput_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interput_axi_gpio_0_1.tcl
