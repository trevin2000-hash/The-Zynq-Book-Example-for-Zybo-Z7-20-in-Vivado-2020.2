...
HD_PWD='/home/trevin/Documents/Soc_Projects/zybo_excrises/zybo_exercise_2/zybo_exercise_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interput_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interput_wrapper.tcl
